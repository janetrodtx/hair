...
# --- Step 4 (Alt): Show Styling Products ---
elif st.session_state.step == 4 and st.session_state.journey == "Styling Product Recommendations":
    result = df[df["Styling Goal"] == st.session_state.styling_goal].iloc[0]

    st.markdown(f"<h2 style='text-align:center;'>Products for {result['Styling Goal']}</h2>", unsafe_allow_html=True)
...
# --- Step 10: Final Bio + Social Links ---
